...
### 2.7.3 Visualising Statistically Significant Local Spatial Autocorrelation Map (Regions)

#### 2.7.3.1 Regionalising the province of Thailand
...
tmap_arrange(central_map, northeastern_map, asp=1, ncol=2)
```
...
The northeaster and central region
...
# Arrange the two maps side by side
tmap_arrange(central_map, western_map, asp=1, ncol=2)
```
...
northeastern_map <- tm_shape(northeastern_lisa_2022) +
  tm_polygons() +
  tm_borders(col = "black", alpha = 0.6) +
  tm_shape(northeastern_lisa_2022) +
  tm_fill("ii", 
          palette = c("#b7dce9","#e1ecbb","#f5f3a6",
                      "#f8d887","#ec9a64","#d21b1c"),
          breaks = c(0, 0.001, 0.01, 0.05, 1),
...
#### 2.7.4.1 **Visualising Statistically Significant LISA Map for Study Area**
